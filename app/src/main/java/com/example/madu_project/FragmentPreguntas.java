...
public class FragmentPreguntas extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        prbarDificultadTiempo2 = view.findViewById(R.id.prbarDificultadTiempo2);
        ...
        getParentFragmentManager().setFragmentResultListener("genero", this, new FragmentResultListener() {
            ...
            public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
                ...
                prbarDificultadTiempo2.setScaleY(2f);
        ...
        btnResp1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                prbarDificultadTiempo2.setVisibility(View.VISIBLE);
                prbarDificultadTiempo2.setProgress(progressBar.getProgress());
    ...
    private void VerificarRespuesta(String respuesta, Boolean esCorrecta) {
        ...
        if (correcto) {
            ...
            for (String[] e : dif) {
                if (e[0].equals(String.valueOf(activity.duracion)))
                    valorDificultad = Integer.parseInt(e[1]);
            }
